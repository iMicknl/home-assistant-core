...
@pytest.mark.parametrize(
    ...
    [
        ...
        # A 502 returned as HTML surfaces as a generic aiohttp ClientError
        # (ContentTypeError) instead of a typed Overkiz exception.
        ClientError("502, message='unexpected mimetype: text/html'"),
    ],
    ids=["service_unavailable", "maintenance", "bad_gateway"],
)
