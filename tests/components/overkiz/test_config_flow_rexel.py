...
REXEL_AUTHORIZE_URL = (
    "https://consumerlogin.rexelservices.fr/"
    "670998c0-f737-4d75-a32f-ba9292755b70/oauth2/v2.0/authorize"
)
REXEL_TOKEN_URL = (
    "https://consumerlogin.rexelservices.fr/"
    "670998c0-f737-4d75-a32f-ba9292755b70/oauth2/v2.0/token"
    "?p=b2c_1a_signinonlyhomeassistant"
)
CLIENT_ID = "2b635ede-c3fb-43bc-8d23-f6d17f80e96d"
...
async def test_full_flow_single_gateway(
    ...
    assert REXEL_AUTHORIZE_URL in result["url"]
    ...
    assert "p=b2c_1a_signinonlyhomeassistant" in result["url"]
