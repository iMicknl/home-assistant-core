...
class AtlanticPassAPCDHW(OverkizEntity, WaterHeaterEntity):
    ...
    def target_temperature(self) -> float:
        ...
        return cast(
            float,
            self.device.get_state_value(OverkizState.CORE_TARGET_DWH_TEMPERATURE),
        )
    ...
    def is_boost_mode_on(self) -> bool:
        ...
        return (
            self.device.get_state_value(OverkizState.CORE_BOOST_ON_OFF)
    ...
    def is_eco_mode_on(self) -> bool:
        ...
        return (
            self.device.get_state_value(OverkizState.IO_PASS_APCDWH_MODE)
    ...
    def is_away_mode_on(self) -> bool:
        ...
        return (
            self.device.get_state_value(OverkizState.CORE_DWH_ON_OFF)
