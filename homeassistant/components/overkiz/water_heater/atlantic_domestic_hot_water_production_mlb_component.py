...
class AtlanticDomesticHotWaterProductionMBLComponent(OverkizEntity, WaterHeaterEntity):
    ...
    def target_temperature(self) -> float:
        ...
        return cast(
            float,
            self.device.get_state_value(OverkizState.CORE_WATER_TARGET_TEMPERATURE),
        )
    ...
    def is_boost_mode_on(self) -> bool:
        ...
        return self.device.get_state_value(OverkizState.MODBUSLINK_DHW_BOOST_MODE) in (
    ...
    def is_eco_mode_on(self) -> bool:
        ...
        return self.device.get_state_value(OverkizState.MODBUSLINK_DHW_MODE) in (
    ...
    def is_away_mode_on(self) -> bool:
        ...
        return self.device.get_state_value(
    ...
    def current_operation(self) -> str:
        ...
        if (
            cast(str, self.device.get_state_value(OverkizState.MODBUSLINK_DHW_MODE))
